...
function getaccount() {
  ...
  axios({
    ...
    for (var i = 0; i < cardData.length; i++) {
      ...
      p.appendChild(balanceContent);
      swiperSlide.appendChild(p);

      var br1 = document.createElement('br');
      swiperSlide.appendChild(br1);
      // var br2 = document.createElement('br');
      // swiperSlide.appendChild(br2);


      // let lastFourDigits = cardData[i].cardID.slice(-4);
      let lastFourDigits = cardData[i].cardID;
      var content = document.createTextNode(lastFourDigits);
      // console.log(cardData[i].cardID);
      var h = document.createElement('h3');
      h.appendChild(content);
      swiperSlide.appendChild(h);
